...
| --------------------------------------------------- | ------- | ---------------- | ---------------------------------------------------------------- |
| [`@kelex/plugin-renderer-html`](./renderer-html.md) | shipped | `string` of HTML | classless, zero dependencies, native validation attributes       |
...
| ------------------------------------------------- | ------- | ------------------------ | ---------------------------------------------- |
| [`@kelex/plugin-handler-post`](./handler-post.md) | shipped | async POST, no framework | native HTML5 validation, self-contained script |
